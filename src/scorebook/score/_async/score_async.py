...
async def score_async(
    ...
    metric_scores = await _compute_metric_scores(outputs, labels, metric_instances)
...
async def _compute_metric_scores(
    outputs: List[Any],
    labels: List[Any],
...
async def _upload_results_async(
    metric_scores: Dict[str, Dict[str, Any]],
    items: List[Dict[str, Any]],
    inputs: List[Any],
    outputs: List[Any],
