...
def execute_runs(
    ...
    def worker(
        ...
        run_result = execute_run(inference, run, experiment_id, project_id, metadata)
...
def upload_classic_run_results(
    ...
    trismik_client = get_trismik_client(upload_classic_run_results)
...
def run_adaptive_evaluation(
    ...
    """
    trismik_client = get_trismik_client(run_adaptive_evaluation)
